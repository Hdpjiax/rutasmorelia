...
// 1. Load env variables from apps/api/.env
...
if (!dbUrlMatch) {
  console.error("Error: DATABASE_URL not found in apps/api/.env");
  process.exit(1);
}
...
if (!sqlFilePath) {
  console.error("Usage: node tools/apply_sql.js <path_to_sql_file>");
  process.exit(1);
}
